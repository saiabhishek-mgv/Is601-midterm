"""
Unit tests for the Calculation class and its operations.
"""
...
def test_calculation_repr():
    ...
    assert calc.__repr__()==expected_repr,"The __repr__ method output does not match the expected string."  # pylint: disable=line-too-long
